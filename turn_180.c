...
int main() 
{
  ...
  //  ------  battery example --------------------------------------------------
	...
	while(kb_kbhit()==0)
	{
		l_mot 	= (double)-((22/7)+ang2)*20/KH4_SPEED_TO_MM_S;
		r_mot 	= (double)((22/7)-ang1)*20/KH4_SPEED_TO_MM_S;
		kh4_set_speed(l_mot ,r_mot ,dsPic);


		kh4_get_position(&lpos2,&rpos2,dsPic);
		turn1	= (rpos2 - rpos1)*KH4_PULSE_TO_MM;
		ang1	= turn1/(105.4/2);

		turn2	= (lpos2 - lpos1)*KH4_PULSE_TO_MM;
		ang2	= turn2/(105.4/2);
	}
